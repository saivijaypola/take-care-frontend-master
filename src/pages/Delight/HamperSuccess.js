                ...
                <div>
                    <Container className="relative rise-card2">
                       <div className="text-center" style={{padding:80, paddingBottom:20}}>
                           ...
                           We are so excited that you have chosen YoCo to delight your loved ones! The YoCo Delights request you posted has been notified to the concerned service provider.
                           </p>
                           <br/>
                       ...
                       <div className="next-grey">
                           ...
                           <Col md="2"></Col>
                               ...
                               <div className="next-card">
                                        ...
                                        <p className="font14">
                                        Once you click "View Request" below, you can see the details of the service provider who will coordinate the delivery of your chosen delight. You can initiate a conversation with them to give instructions / customise your request further.
                                        </p>
                                   </div>
                               </Col>
                               <Col md="4">
                                   <div className="next-card">
                                        ...
                                        <p className="font14">
                                        You can also go through the quote the service provider gives you after details of delivery have been discussed. This includes delivery charges, if any, or other customization charges as applicable, above the original price.
                                        </p>
                                   </div>
                               </Col>
                               <Col md="2"></Col>
