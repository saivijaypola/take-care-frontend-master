...
export class ProviderListingTimeLine extends Component {
    constructor(props) {
    ...
    render() {
        ...
        return (<React.Fragment>
            <section style={{ paddingTop: 60 }} className="purple-backdrop purple-bg">
                <Container>
                    <Row>
                        <Col lg="12" xs="12" >
...
export default connect(mapStateToProps, mapDispatchToProps)(ProviderListingTimeLine)