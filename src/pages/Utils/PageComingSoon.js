...
// import images
import comingsoon from '../../assets/images/coworking/holding-hands.jpg';
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <section className="bg-home d-flex align-items-center" style={{ backgroundImage: `url(${comingsoon})` }}>
                    <div className="bg-overlay"></div>
                    <Container>
                        <Row className="justify-content-center">
                            <Col lg="8" md="12" className="text-center">
                                <Link to="#" className="text-white title-dark logo h5">YoCo<span className="text-primary">.</span></Link>
                                <div className="text-uppercase title-dark text-white mt-2 mb-4 coming-soon">We're Coming soon...</div>
                                <p className="text-light para-desc para-dark mx-auto">Start working with <span className="text-primary font-weight-bold">YoCo</span> that can provide everything you need to generate awareness, drive traffic, connect.</p>
                            </Col>
                        </Row>
