...
class Recommendation extends Component {
    ...
    renderRecommendations = (rec, index) => <li key={index} style={{ boxShadow: '0 0 3px rgba(60, 72, 88, 0.15) !important', border: 'solid 0.5px #efefef', borderRadius: '10px !important' }} className={this.props.key === 0 ? "d-flex p-3 bg-white rounded " : "d-flex p-3 bg-white rounded  mt-4"} >
        ...
        <div className="content" style={{ width: '100%' }}>
            <Row>
                <Col md="10" xs="9">
                    <p style={{ wordWrap: "break-word" }} className="title mb-0 font16 bold">{rec.name}</p>

                    <p style={{ wordWrap: "break-word", fontSize: 12 }} className="font-title mb-0">{rec.email}</p>
            ...
            <Fragment>
                <Row>
                    <Col lg="10" className="clearfix" >
                        <p style={{ fontWeight: 'bold', fontSize: 17, marginBottom: 2 }}>It is always better and more believable if other people can talk for you. </p>
                        <p style={{fontSize:12.5, color:'#616161'}}>In this section, give the contact of people who know you and will recommend you. Recommendations from your teachers / managers / any other respected individuals add credibility to your profile.</p>
                    </Col>
                        ...
                        errorMessage !== '' ? (
                            ...
                            <ModalBody>
                                <div className="text-center" style={{ padding: 30, }}>
                                    <p className="font16 title mb-1">{errorMessage}</p>
                                    <p className="font-title para-desc mx-auto mb-4">{errorDescription}</p>
                                ...
                                <ModalBody>
                                    <div className="text-center" style={{ padding: 30 }}>
                                        <p className="title mb-1 font16 bold">Success</p>
                                        <p className="font-title para-desc mx-auto mb-4">You have successfully sent recommendation invite. </p>
                    ...
                    <ModalBody>
                        ...
                        <div className="component-wrapper rounded" >
                            <div className="p-4 border-bottom">
                                <p className="font16 title mb-0 bold">Recommendation Status</p>
                            </div>

                            <div className="p-4">
                                <Alert color="success">
                                    <p className="font16 alert-heading bold">{selectedRecommendation.name}</p>
