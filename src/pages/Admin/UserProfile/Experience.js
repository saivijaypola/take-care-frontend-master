        ...
        <div className="content" style={{ width: '100%' }}>
            <Row>
                <Col md="10" xs="8">
                    ...
                    <p className="text-muted mb-0"><Link to="#" className="text-primary">{emp.companyName}</Link> @{emp.description}</p>
                    <p className="text-muted mb-0">{`${emp.fromYear}${emp.toYear && emp.toYear !== '' ? ' - ' + emp.toYear : ''}`}</p>
                </Col>
                <Col md="1" xs="2">
