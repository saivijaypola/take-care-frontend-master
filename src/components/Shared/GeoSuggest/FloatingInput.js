...
class FloatingInput extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <img onClick={() => this.resetLocation() } className="geoclose pointer" src={close}></img>
                <Geosuggest
...
export default connect(mapStateToProps, { ...ProfileAction,...RequestActions })(FloatingInput)