...
class UploadAdressProof extends Component {
    ...
    async componentDidMount() {
        var user = await firebase.auth().onAuthStateChanged((user) => {
            if (user) {
...
export default connect(mapStateToProps, { ...ProfileAction, ...DocumentsActions })(UploadAdressProof);